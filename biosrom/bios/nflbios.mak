...
# C Source Modules
#
CSRCS= 	__main.c nflbmain.c conf.c io.c $(TTY_DRIVER) ioasic.c $(SYS_CONTROL) \
...
#
all:	$(BUILDDIR)\nflbios.bin
	@echo NFLBIOS for $(GAME) PIC on $(TARGET_SYS)
	@echo DONE
...
#
$(BUILDDIR)\nflbios.bin:	$(OBJS) nflbios.lnk
	@$(LINK) /p @nflbios.lnk,$(BUILDDIR)/nflbios.bin,nflbios.sym,nflbios.map > nflbios.log
	@echo NFLBIOS.BIN for $(GAME) PIC on $(TARGET_SYS) DONE

nflbios.lnk:	biosbin.in bflist.in
	@if EXIST nflbios.lnk del nflbios.lnk
	@copy biosbin.in+bflist.in nflbios.lnk > NUL:
	@echo 	include	"nflbmain.o" >> nflbios.lnk
	@echo 	include	"$(TTY_DRIVER:.c=.o)" >> nflbios.lnk
	@echo 	include	"$(SYS_CONTROL:.c=.o)" >> nflbios.lnk
	@echo 	include	"$(SND_DRIVER:.c=.o)" >> nflbios.lnk
	@echo 	include	"$(IDE_DRIVER:.c=.o)" >> nflbios.lnk
...
nflbmain.c:	nflmain.c
	@if EXIST nflbmain.c del nflbmain.c
	@copy nflmain.c nflbmain.c > NUL:
...
.PHONY:	conf.o exec.o ginit.o memtest.o idedrv.o bgt64010.o nflbmain.o
...
ifneq	($(wildcard *.log),)
	...
	@echo NFLBIOS CLEAN DONE

#
# How to clean up for a relink
#
clobber:
	@echo NFLBIOS CLOBBER
	@if EXIST $(BUILDDIR)\nflbios.bin del $(BUILDDIR)\nflbios.bin
	@echo NFLBIOS CLOBBER DONE

#
# What to do for a complete rebuild
#
rebuild:	clean
	@echo NFLBIOS REBUILD for $(TARGET_SYS)
	@$(MAKE) --no-print-directory -f nflbios.mak
	@echo NFLBIOS REBUILD for $(TARGET_SYS) DONE
