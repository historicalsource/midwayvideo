...
# C Source Modules
#
CSRCS= 	__main.c cbmain.c conf.c io.c $(TTY_DRIVER) ioasic.c $(SYS_CONTROL) \
...
#
all:	$(BUILDDIR)\carnbios.bin
	@echo CARNBIOS for $(GAME) PIC on $(TARGET_SYS)
	@echo DONE
...
#
$(BUILDDIR)\carnbios.bin:	$(OBJS) carnbios.lnk
	@$(LINK) /p @carnbios.lnk,$(BUILDDIR)/carnbios.bin,carnbios.sym,carnbios.map > carnbios.log
	@echo CARNBIOS.BIN for $(GAME) PIC on $(TARGET_SYS) DONE

carnbios.lnk:	biosbin.in bflist.in
	@if EXIST carnbios.lnk del carnbios.lnk
	@copy biosbin.in+bflist.in carnbios.lnk > NUL:
	@echo 	include	"cbmain.o" >> carnbios.lnk
	@echo 	include	"$(TTY_DRIVER:.c=.o)" >> carnbios.lnk
	@echo 	include	"$(SYS_CONTROL:.c=.o)" >> carnbios.lnk
	@echo 	include	"$(SND_DRIVER:.c=.o)" >> carnbios.lnk
	@echo 	include	"$(IDE_DRIVER:.c=.o)" >> carnbios.lnk
...
cbmain.c:	cmain.c
	@if EXIST cbmain.c del cbmain.c
	@copy cmain.c cbmain.c > NUL:
...
.PHONY:	conf.o exec.o ginit.o memtest.o idedrv.o bgt64010.o cbmain.o
...
ifneq	($(wildcard *.log),)
	...
	@echo CARNBIOS CLEAN DONE

#
# How to clean up for a relink
#
clobber:
	@echo CARNBIOS CLOBBER
	@if EXIST $(BUILDDIR)\carnbios.bin del $(BUILDDIR)\carnbios.bin
	@echo CARNBIOS CLOBBER DONE

#
# What to do for a complete rebuild
#
rebuild:	clean
	@echo CARNBIOS REBUILD for $(TARGET_SYS)
	@$(MAKE) --no-print-directory -f carnbios.mak
	@echo CARNBIOS REBUILD for $(TARGET_SYS) DONE
