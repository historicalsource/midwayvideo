...
**
** $Header: /video/include/glide244/fxglide.h 1     2/12/98 4:56p Mlynch $
** $Log: /video/include/glide244/fxglide.h $
 * 
 * 1     2/12/98 4:56p Mlynch
 * Include files for GLIDE version 2.44
 * 
 ...
 * fixed my fifo fuckage
 * 
 * 79    8/19/97 8:54p Peter
 * lots of stuff, hopefully no fuckage
 * 
 ...
 * Fixed fuckage in the Nudge Of Love
 * 
 * 74    7/08/97 1:29p Jdt
 * Fixed watcom fuckage
 * 
 ...
 * Changed GR_ASSERT to fix stack fuckage
 * 
 ...
 * Hopefully removed the rest of my fuckage. 
 * 
...
#define SETF(d,s)       _grSst96Store32F((float *) &d, s)
  ...
  extern FxU32 __cdecl _GR_GET(void *);
  extern void __cdecl _GR_SET16(void *, unsigned short);
  extern void __cdecl _GR_SET(void *, unsigned long);
  extern void __cdecl _GR_SETF(void *, float);
