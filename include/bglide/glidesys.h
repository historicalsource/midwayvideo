...
**
** $Header: /Releases/Banshee/GLOP/3Dfx/Devel/H3/glide3/src/glidesys.h 1     9/02/98 12:36a Sapphire $
** $Log: /Releases/Banshee/GLOP/3Dfx/Devel/H3/glide3/src/glidesys.h $
** 
...
// KEENAN PORT
#define GLIDE_OS GLIDE_OS_OTHER
#elif defined(__GOOSE__)
#  define GLIDE_OS        GLIDE_OS_GOOSE
#else
#error "Unknown OS"
#endif
