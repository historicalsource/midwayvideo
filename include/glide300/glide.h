...
#define MAX_MIPMAPS_PER_SST    256
#else
#define MAX_NUM_SST            1
#define MAX_MIPMAPS_PER_SST    2
#endif
#endif
...
#define GR_ALPHASOURCE_TEXTURE_ALPHA_TIMES_CONSTANT_ALPHA 0x4
...
#define GR_COLORCOMBINE_DECAL_TEXTURE_ADD_CCALPHA	0x11
...
#define GR_TEXCHROMA_DISABLE               0x0
#define GR_TEXCHROMA_ENABLE                0x1
#define GR_TEXCHROMA_ENABLE_SUBSTITUTE_RGB 0x2

#define GR_TEXCHROMARANGE_RGB_ALL  0x0
...
#define GR_TEXTURECLAMP_MIRROR  0x2
...
#define GLIDE3_EXTRA_STATE      288

#define GLIDE_STATE_PAD_SIZE 312 + GLIDE3_EXTRA_STATE 

#define GLIDE_VERTEX_LAYOUT_PAD_SIZE    100

#ifdef GLIDE_LIB
typedef struct _GrState_s GrState;
typedef struct _GrVertexLayout_s GrVertexLayout;
#else
typedef struct _GrState_s {
  char pad[GLIDE_STATE_PAD_SIZE];
} GrState;

typedef struct _GrVertexLayout_s {
  char pad[GLIDE_VERTEX_LAYOUT_PAD_SIZE];
} GrVertexLayout;
#endif
...
#define GR_NON_POWER_OF_TWO_TEXTURES    0x0e
...
#define GR_VERTEX_PARAMETER             0x25
...
FX_ENTRY void FX_CALL
grGlideGetVertexLayout( GrVertexLayout *layout );

FX_ENTRY void FX_CALL
grGlideSetVertexLayout( const GrVertexLayout *layout );
