...
**
** $Header: /devel/cvg/glide3/src/fxglide.h 17    5/01/98 12:03p Atai $
** $Log: /devel/cvg/glide3/src/fxglide.h $
** 
...
#if GLIDE_PACKED_RGB
FxI32 FX_CSTYLE
_trisetup_cull_rgb(const void *va, const void *vb, const void *vc);
FxI32 FX_CSTYLE
_trisetup_cull_argb(const void *va, const void *vb, const void *vc);
...
#elif USE_PACKET_FIFO && GLIDE_USE_SHADOW_FIFO 
#undef SET
#define SET(d, s) \
do { \
  GR_DCL_GC; \
...
#if (GLIDE_PLATFORM & GLIDE_HW_CVG)
#define TEX_ROW_ADDR_INCR(__t, __width) ((__t) << 9)
#elif (GLIDE_PLATFORM & GLIDE_HW_H3)
#define TEX_ROW_ADDR_INCR(__t, __width) ((__t) * (__width))
#else
