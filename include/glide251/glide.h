...
// Vertex structure for textured only triangles
// Uses include textured triangle with or without constant alpha
typedef struct
{
	float	x;
	float	y;
...
// This is just here to prevent having to change a bunch of source code
typedef MidVertexWithT	MidVertex;
